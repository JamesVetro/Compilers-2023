export class Lexertoken {
    ...
    enum TokenType {
      ...
      class Token {
        ...
        constructor(type: TokenType, value: any, pos: number) {
          this.type = type;
          this.value = value;
          this.pos = pos;
        }
            ...
            while(true){
                ...
                if(LockUp == "i"){
                    if(Block.charAt(1) == "n" && Block.charAt(2) == "t"){
                        ...
                        return new Token(TokenType.INT, LockUp, this.pos - LockUp.length);
                    }else if(Block.charAt(1)=="f"){
                        LockUp += Block.charAt(1)
                        Block = Block.substring(2)
                        return new Token(TokenType.IF, LockUp, this.pos - LockUp.length);
                    }else{
                        Block = Block.substring(1)
                        return new Token(TokenType.VARIABLE, LockUp, this.pos - LockUp.length);
                    }
                    ...
                    return new Token(TokenType.TRUE, LockUp, this.pos - LockUp.length);
                    ...
                    return new Token(TokenType.FALSE, LockUp, this.pos - LockUp.length);           
                    ...
                    return new Token(TokenType.STRING, LockUp, this.pos - LockUp.length);   
                }else if(LockUp == "p"&& Block.charAt(1) == "r"&& Block.charAt(2) == "i" && Block.charAt(3) == "n"&& Block.charAt(4) == "t"){
                    LockUp += Block.charAt(1) + Block.charAt(2) + Block.charAt(3) + Block.charAt(4)
                    Block = Block.substring(5)
                    return new Token(TokenType.PRINT, LockUp, this.pos - LockUp.length);
                }else if(LockUp == "w"&& Block.charAt(1) == "h"&& Block.charAt(2) == "i" && Block.charAt(3) == "l"&& Block.charAt(4) == "e"){
                    LockUp += Block.charAt(1) + Block.charAt(2) + Block.charAt(3) + Block.charAt(4)
                    Block = Block.substring(5)
                    return new Token(TokenType.WHILE, LockUp, this.pos - LockUp.length);
                    ...
                    return new Token(TokenType.BOOLEAN, LockUp, this.pos - LockUp.length); 
                }else{
                    Block = Block.substring(1)
                    return new Token(TokenType.VARIABLE, LockUp, this.pos - LockUp.length);
                }
